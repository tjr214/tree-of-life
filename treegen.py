...
def display_banner() -> None:
    ...
    banner = r"""
    _______ _______         _______  _____  _____   _      _  _____  ______  _____
    |__   __| ____\ \       / /  __ \|  __ \|  __ \ | |    | ||  ___|| |  _ \|  __ \
       | |  | |__  \ \   / /  | |  | | |  | | |  | || |    | || |    | | | || |  | |
       | |  |  __|  \ \ / /   | |  | | |  | | |  | || |    | || |    | | | || |  | |
       | |  | |___   \   /    | |__| | |__| | |__| || |____| || |____| |_| || |__| |
       |_|  |_____|   \_/     |_____/|_____/|_____/ |________|\_____||____(_)_____/
                                                                                    
     _____  __  __         _____  _____  _____   _____  ______  _   _ 
    |_   _||  \/  |/\     / ____||  __ \|  __ \ / ____||  ____|| \ | |
      | |  | \  / /  \   | |  __ | |__) | |__) | |  __ | |__   |  \| |
      | |  | |\/| / /\ \  | | |_ ||  ___/|  _  /| | |_ ||  __|  | . ` |
     _| |_ | |  |/ ____ \ | |__| || |    | | \ \| |__| || |____ | |\  |
    |_____||_|  /_/    \_\ \_____||_|    |_|  \_\\_____||______||_| \_|
    """
